...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-6 relative">
      ...
      <div className="w-full max-w-md p-[4px] bg-gradient-to-br from-primary via-indigo-600 to-purple-700 rounded-[32px] shadow-[0_32px_64px_-16px_rgba(79,70,229,0.3)]">
        <div className="w-full bg-white p-8 rounded-[28px]">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-zinc-50 border border-zinc-300 px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm shadow-sm"
